...
{
    ui->setupUi(this);
    connect(ui->cmdCalcular, SIGNAL(triggered(bool)),
            this, SLOT(on_cmdCalcular_released()));
    connect(ui->cmdGuardar,SIGNAL(triggered(bool)),
            this, SLOT(guardar()));
    connect(ui->cmdAbrir,SIGNAL(triggered(bool)),
            this, SLOT(abrir()));
}
...
{
    QString resultados = ui->outResultado->toPlainText();
